...
// Notes   : Extracts 1D column waves for display.
// ------------------------------------------------------------
Function IV_graph()
    ...
    xw[] = IV_trace[p][1]   // column 1 = voltage
    yw[] = IV_trace[p][0]   // column 0 = current
...
Function plot_raw_panel()
    ...
    NewPanel/K=1/N=$panel_name/W=(50,50,750,600) as panel_title

    DrawText 15, 28,  "Current traces"
    DrawText 15, 318, "Stimulus"

    // Create hosted subgraphs — stacked vertically, same left/right bounds
    Display/HOST=$panel_name/N=Traces/W=(55,35,690,305)
    Display/HOST=$panel_name/N=Stim/W=(55,320,690,530)
    ...
    Label/W=$(panel_name+"#Traces") left   "Current (A)"
    Label/W=$(panel_name+"#Traces") bottom ""
