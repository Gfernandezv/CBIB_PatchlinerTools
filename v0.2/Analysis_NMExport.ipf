...
Function ExportChannelToNM()
    ...
    String chan_list = NMExport_ListSubfolders(current_folder, "chan_")
...
Function NMExport_CopyWaves(chan_path, nm_folder, nm_prefix, src_type, chan_letter)
    ...
    String exp_list = NMExport_ListSubfolders(chan_path, "exp_")
...
// ------------------------------------------------------------
// Function: NMExport_ListSubfolders
...
// Notes   : Generic helper — no NM-specific or electrophysiology
//           domain logic. Parses DataFolderDir(1) output.
//           Assumes folder names contain no commas or spaces,
//           consistent with the chan_X / exp_Y naming convention.
// ------------------------------------------------------------
Function/S NMExport_ListSubfolders(parent_path, name_prefix)
